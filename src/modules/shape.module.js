    ...
    trigger() {
        menuElementHTML.addEventListener('click', event => {
            if (event.target.dataset.type === 'shape') {
                ...
                createElement.style.borderRadius = random('30', '50').toString() + 'px'
                createElement.style.width = random('100', '300').toString() + 'px'
                createElement.style.height = random('100', '300').toString() + 'px'
                ...
                createElement.style.right = random('100', '500') + 'px'
                createElement.style.left = random('100', '500') + 'px'
